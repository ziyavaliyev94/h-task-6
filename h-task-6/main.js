...
// tasks
// 1) goz rengi yasil olanlari yeni bir array yaradib ona push edecek function yazin
...
// 2) city i "San Francisco" olan obyektleri yeni arraye elave edib logda yazdiran function yaradin

// function city() {
//     let sanFransisco = []
//     for (let user of users) {
//         if (user.address.city == "San Francisco") {
//             sanFransisco.push(user)
...
// 3) departamenti Engineering i olanlari secib bir arraye elave edib loga cixaran func yazin

// function depart() {
//     let enginDepart = []
//     for (let user of users) {
//         if (user.company.department == "Engineering") {
//             enginDepart.push(user)
//             console.log(enginDepart);           
//         }
//     }
// }
// depart()

// 4) cinsi (gender) male ve famale olanlari ayri ayri arrayde cixaran function yaradin
...
//         }
//     }
//     return { arrMale, arrFemale }
// }
// let result = genderFilter()
// console.log("male:", result.arrMale);
// console.log("female:", result.arrFemale);



// 5) 4 cu taskdaki arraydeki male ve ya famele olan arrayden her hansisa elementi silen function yazin
// meselen name olaraq parametre ad verilsin hemin arrayden hemin adli object silinsin meselen : deleteArray("Addison")
